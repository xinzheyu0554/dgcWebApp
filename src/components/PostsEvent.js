import {
  ...
  import useMutation1 from '../hooks/useMutation1';
  import useQuery1 from '../hooks/useQuery1';
...
const PostsEvent = () => {
    ...
    const {
      ...
      isLoading: uploading,
      error: uploadError,
    } = useMutation1({ url: URL });
  
    const {
      data: imageUrls = [],
      isLoading: imagesLoading,
      error: fetchError,
    } = useQuery1(URL, refetch);
    ...
    return (
        ...
        <div className="pp-gallery">
          <div className="card-columns">     
              {imageUrls?.length > 0 && imageUrls.pop() && imageUrls.map((a) => {
                  return (
